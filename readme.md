* Task 1:  Build a Dockerfile to create an image for this app.  HINT:  You'll need to start from the python:3.8.3 base image, install requirements.txt with pip, and start the app by running python flaskapp.py. 
